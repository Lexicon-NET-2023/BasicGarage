        ...
        while (true)
        {
            ...
            switch (input)
            {
                case ConsoleKey.D1:
                    ...
                    ui.PrintList(currGarage.GetGarage());
                    break;
                case ConsoleKey.D2:
                    ui.Output("Skriv in registreringsnummret du vill hitta.");
                    string regNr = ui.GetInput();
                    ui.PrintVehicle(currGarage.GetFromRegNr(regNr));
                    break;
                case ConsoleKey.D3:
                    AddVehicle(currGarage, ui);
                    break;
                case ConsoleKey.D4:
                    RemoveVehicle(currGarage, ui);
                    break;
                case ConsoleKey.D5:
                    PrintTypes(currGarage, ui);
                    break;
                case ConsoleKey.D6:
